...
import { Plus, Bot, Users, Trash2, Pencil } from "lucide-react"
...
export function EntitySelector({ onAddAgent, onAddTeam, onEditAgent, hideAddAgent, hideAddTeam }: EntitySelectorProps) {
